...
def main():
    output = open('short_3path_cdata.pkl', 'wb')
    path_dict = {}
    state_dict = {}
    num_id = 0
    sum_ratio = 0
    num_path_dict = {}
    with open("../../dataset/MixVul/llm/train_512.json") as f:
        datas = json.load(f)
        for js in datas:
            num_id += 1
            if num_id%100 == 0:
    ...
    with open("../../dataset/MixVul/llm/valid_512.json") as f:
        datas = json.load(f)
        for js in datas:
            num_id += 1
            if num_id%100==0:
    ...
    with open("../../dataset/MixVul/llm/test_512.json") as f:
        datas = json.load(f)
        for js in datas:
            num_id += 1
            if num_id%100==0:
